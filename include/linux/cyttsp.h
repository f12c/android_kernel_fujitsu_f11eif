...
/* FUJITSU:2011/03/03 add Start */
#define CY_I2C_XRST_GPIO    142     /* RESET GPIO add 2011/02/21 */
#define CY_I2C_IRQ_GPIO     18      /* INT GPIO add 2011/02/21 */
#define CY_I2C_ADR          0x3B    /* CYTTSP I2C SLAVE ADDR 2011/03/16 0x04->0x3B */
/* FUJITSU:2011/03/03 add end */
/* Scan Type selection for finger and/or stylus activation */
#define CY_SCN_TYP_DFLT 0x01 /* finger only mutual scan */
/* Active Power state scanning/processing refresh interval */
#define CY_ACT_INTRVL_DFLT 0x00 /* ms */    /* FUJITSU:2011/03/03 0x0A Vict param 10ms */
/* touch timeout for the Active power */
#define CY_TCH_TMOUT_DFLT 0x64 /* ms */     /* FUJITSU:2011/03/03 0x0A Vict param 100ms */
/* Low Power state scanning/processing refresh interval */
#define CY_LP_INTRVL_DFLT 0x32 /* ms */     /* FUJISTU:2011/03/03 0x04 Vict param 40ms */
/*
