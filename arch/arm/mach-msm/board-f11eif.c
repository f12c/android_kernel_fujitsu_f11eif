...
#define MSM_PMEM_SF_SIZE	0x1F00000 /*default 0x1F00000 2012-11-20 change jellicle */
...
#define MSM_PMEM_ADSP_SIZE        0x2600000  /*0x3800000*/ /* default 0x1E00000 2012-11-20 change jellicle */
...
/* FUJITSU:2011-04-26 USB start */
	...
	.product_id	= 0x12AB,
	.version	= 0x0100,
	.product_name		= "Fujitsu Android Phone",
...
static int display_common_power(int on)
{
    ...
    struct i2c_msg msg;
    u_int8_t buffer[8];
/* FUJITSU:2011-08-23 i2c-retry start */
    int try = 0;
/* FUJITSU:2011-08-23 i2c-retry end */
...
/* FUJITSU:2011-08-23 i2c-retry start */
	#if 1
			pr_err("[DD](%s):I2C ERROR -1- [%d] ret = %d\n",__func__, __LINE__, ret);
...
/* FUJITSU:2011-08-23 i2c-retry start */
	#if 1
				pr_err("[DD](%s):I2C ERROR -2- [%d] ret = %d\n",__func__, __LINE__, ret);
				for (try = 0; try < 50; try++) {
					msleep(5);
					ret = i2c_transfer(i2c_lcd, &msg, 1);
					if (ret >= 0 ) {
...
/* FUJITSU:2011-08-23 i2c-retry start */
	#if 1
				pr_err("[DD](%s):I2C ERROR -3- [%d] ret = %d\n",__func__, __LINE__, ret);
				for (try = 0; try < 50; try++) {
					msleep(5);
					ret = i2c_transfer(i2c_lcd, &msg, 1);
					if (ret >= 0 ) {
...
/* FUJITSU:2011-08-23 i2c-retry start */
                //pr_err("[DD](%s):I2C ERROR [%d] ret = %d\n",__func__, __LINE__, ret);
				pr_err("[DD](%s):I2C ERROR -4- [%d] ret = %d\n",__func__, __LINE__, ret);
/* FUJITSU:2011-08-23 i2c-retry end */
                return ret;
            }
...
/* FUJITSU:2011-08-23 i2c-retry start */
                //pr_err("[DD](%s):I2C ERROR [%d] ret = %d\n",__func__, __LINE__, ret);
				pr_err("[DD](%s):I2C ERROR -5- [%d] ret = %d\n",__func__, __LINE__, ret);
/* FUJITSU:2011-08-23 i2c-retry end */
                return ret;
            }
...
/* FUJITSU:2011-08-23 i2c-retry start */
                //pr_err("[DD](%s):I2C ERROR [%d] ret = %d\n",__func__, __LINE__, ret);
				pr_err("[DD](%s):I2C ERROR -6- [%d] ret = %d\n",__func__, __LINE__, ret);
/* FUJITSU:2011-08-23 i2c-retry end */
                return ret;
            }
        }//backlight_init
...
/* FUJITSU:2011-08-23 i2c-retry start */
	#if 1
				pr_err("[DD](%s):I2C ERROR -7- [%d] ret = %d\n",__func__, __LINE__, ret);
				for (try = 0; try < 50; try++) {
					msleep(5);
					ret = i2c_transfer(i2c_lcd, &msg, 1);
					if (ret >= 0 ) {
						pr_err("[DD](%s):I2C ERROR [%d] ret = %d *7* retry(%d):OK\n",__func__, __LINE__, ret,try);
						break;
					}
				}
				if(ret < 0){
					pr_err("[DD](%s):I2C ERROR [%d] ret = %d *7* retry(%d):NG\n",__func__, __LINE__, ret,try);
					return ret;
				}
	#else
				pr_err("[DD](%s):I2C ERROR [%d] ret = %d\n",__func__, __LINE__, ret);
...
/* FUJITSU:2011-08-23 i2c-retry start */
	#if 1
				pr_err("[DD](%s):I2C ERROR -8- [%d] ret = %d\n",__func__, __LINE__, ret);
				for (try = 0; try < 50; try++) {
					msleep(5);
					ret = i2c_transfer(i2c_lcd, &msg, 1);
					if (ret >= 0 ) {
						pr_err("[DD](%s):I2C ERROR [%d] ret = %d *8* retry(%d):OK\n",__func__, __LINE__, ret,try);
						break;
					}
				}
				if(ret < 0){
					pr_err("[DD](%s):I2C ERROR [%d] ret = %d *8* retry(%d):NG\n",__func__, __LINE__, ret,try);
					return ret;
				}
	#else
				pr_err("[DD](%s):I2C ERROR [%d] ret = %d\n",__func__, __LINE__, ret);
...
/* FUJITSU:2011-09-01 change WLAN start */
...
/* FUJITSU:2011-08-23 del SDCard start */
#if 0
	static int enabled_once[] = {0, 0, 0, 0};
#endif
/* FUJITSU:2011-08-23 del SDCard end */
...
extern void msm_init_pmic_vibrator(void);		//vibe add
...
/* jellicle 2012-11-20 add factory start */
int factory_mode(void)
{
	return 0;
}
EXPORT_SYMBOL(factory_mode);
/* jellicle 2012-11-20 add factory end */
