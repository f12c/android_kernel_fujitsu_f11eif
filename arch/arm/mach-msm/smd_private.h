...
/* FUJITSU:2011-04-14 Modified for GB start */
typedef unsigned long qword[ 2 ];

#define SMEM_V1_OEM_001_SIZE		(9)
#define SMEM_V1_OEM_007_SIZE		(4096)
#define SMEM_V1_OEM_008_SIZE		(512)
#define SMEM_V1_OEM_009_SIZE		(512)
#define SMEM_V1_OEM_011_SIZE		(8)
...
typedef struct {
	unsigned char				smem_v1_oem_001[SMEM_V1_OEM_001_SIZE];
	unsigned char				smem_v1_oem_002;
	unsigned char				smem_v1_oem_003;
	int							smem_v1_oem_004;
	int							smem_v1_oem_005;
	qword						smem_v1_oem_006;
	unsigned char				smem_v1_oem_007[SMEM_V1_OEM_007_SIZE];
	unsigned char				smem_v1_oem_008[SMEM_V1_OEM_008_SIZE];
	unsigned char				smem_v1_oem_009[SMEM_V1_OEM_009_SIZE];
	smem_led_color_type			smem_v1_oem_010;
	uint8_t						smem_v1_oem_011[SMEM_V1_OEM_011_SIZE];
	unsigned char				smem_v1_oem_012; /* FUJITSU:2011-05-24 add */
} smem_vendor1_data_type;


typedef enum
{
	SMEM_TSB_START_ID_V1 = 0,
	SMEM_OEM_001,
	SMEM_OEM_002,
	SMEM_OEM_003,
	SMEM_OEM_004,
	...
	SMEM_OEM_012,
	SMEM_TSB_LAST_ID_V1
} smem_mem_vendor1_type;

void *smem_alloc_vendor1(smem_mem_vendor1_type smem_v1_type);
/* FUJITSU:2011-04-14 Modified for GB end */
