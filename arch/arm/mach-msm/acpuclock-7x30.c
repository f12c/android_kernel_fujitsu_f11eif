...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 122880, PLL_3,    5, 5,  61440000,  750, VDD_RAW(750) },	//900
	{ 0, 184320, PLL_3,    5, 4,  61440000,  750, VDD_RAW(750) },	//900
	{ 0, MAX_AXI_KHZ, SRC_AXI, 1, 0, 61440000, 750, VDD_RAW(750) },//900
	{ 1, 245760, PLL_3,    5, 2,  61440000,  750, VDD_RAW(750) },	//900
	{ 1, 368640, PLL_3, 5, 1, 122800000, 800, VDD_RAW(800) },	//900
	{ 1, 460800, PLL_1, 2, 0, 153600000, 850, VDD_RAW(850) },	//900
	{ 1, 576000, PLL_1, 2, 0, 153600000, 900, VDD_RAW(900) },	//950
	{ 1, 652800, PLL_1, 2, 0, 153600000, 950, VDD_RAW(950) },	//950
	{ 1, 768000, PLL_1, 2, 0, 153600000, 950, VDD_RAW(950) },	//950
	{ 1, 806400, PLL_2, 3, 0, UINT_MAX, 975, VDD_RAW(975), &pll2_tbl[0]},	//1000
	{ 1, 921600, PLL_2, 3, 0, UINT_MAX, 975, VDD_RAW(975), &pll2_tbl[1]},	//1000
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 975, VDD_RAW(975), &pll2_tbl[2]},	//1000
	{ 1, 1113000, PLL_2, 3, 0, UINT_MAX, 1025, VDD_RAW(1025), &pll2_tbl[3]},	//1050
	{ 1, 1209600, PLL_2, 3, 0, UINT_MAX, 1050, VDD_RAW(1050), &pll2_tbl[4]},	//1100
...
#else
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	{ 0, 24576,  SRC_LPXO, 0, 0,  30720000,  900, VDD_RAW(900) },	//900
	{ 0, 61440,  PLL_3,    5, 11, 61440000,  900, VDD_RAW(900) },	//900
	{ 1, 122880, PLL_3,    5, 5,  61440000,  900, VDD_RAW(900) },	//900
	{ 0, 184320, PLL_3,    5, 4,  61440000,  900, VDD_RAW(900) },	//900
	{ 0, MAX_AXI_KHZ, SRC_AXI, 1, 0, 61440000, 900, VDD_RAW(900) },//900
	{ 1, 245760, PLL_3,    5, 2,  61440000,  900, VDD_RAW(900) },	//900
	{ 1, 368640, PLL_3, 5, 1, 122800000, 900, VDD_RAW(900) },	//900
	{ 1, 460800, PLL_1, 2, 0, 153600000, 900, VDD_RAW(900) },	//900
	{ 1, 576000, PLL_1, 2, 0, 153600000, 950, VDD_RAW(950) },	//950
	{ 1, 652800, PLL_1, 2, 0, 153600000, 950, VDD_RAW(950) },	//950
	{ 1, 768000, PLL_1, 2, 0, 153600000, 950, VDD_RAW(950) },	//950
	{ 1, 806400, PLL_2, 3, 0, UINT_MAX, 1000, VDD_RAW(1000), &pll2_tbl[0]},	//1000
	{ 1, 921600, PLL_2, 3, 0, UINT_MAX, 1000, VDD_RAW(1000), &pll2_tbl[1]},	//1000
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1000, VDD_RAW(1000), &pll2_tbl[2]},	//1000
	{ 1, 1113000, PLL_2, 3, 0, UINT_MAX, 1050, VDD_RAW(1050), &pll2_tbl[3]},	//1050
	{ 1, 1209600, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), &pll2_tbl[4]},	//1100
	{ 1, 1305600, PLL_2, 3, 0, UINT_MAX, 1150, VDD_RAW(1150), &pll2_tbl[5]},
	{ 1, 1401600, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1200), &pll2_tbl[6]},
	{ 1, 1516800, PLL_2, 3, 0, UINT_MAX, 1250, VDD_RAW(1250), &pll2_tbl[7]},
	{ 1, 1612800, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1350), &pll2_tbl[8]},
