...
void set_speakeramp_reg(int mode); /* FUJITSU:2011-12-01 speaker amp */
...
/* FUJITSU:2011-12-01 speaker power ctrl start */
		if(check_use_speaker()){
			msm_snddev_poweramp_on();
			set_speakeramp_reg(1);
		}
/* FUJITSU:2011-12-01 speaker power ctrl end */
/* FUJITSU:2011-12-01 camera sound start */
		if(check_use_speaker2()){
			msm_snddev_poweramp_on();
			set_speakeramp_reg(2);
		}
/* FUJITSU:2011-12-01 camera sound end */
/* FUJITSU:2011-12-01 speaker power ctrl start */
		else if(check_use_earspeaker()){
			msm_snddev_poweramp_on();
			set_speakeramp_reg(0);
		}
/* FUJITSU:2011-12-01 speaker power ctrl end */
/* FUJITSU:2012-03-12 notify earamp start */
		else if(check_use_speaker3()){
			enable_earamp_reg();
		}
/* FUJITSU:2012-03-12 notify earamp end */
		LOG(EV_ENABLE, 2);
