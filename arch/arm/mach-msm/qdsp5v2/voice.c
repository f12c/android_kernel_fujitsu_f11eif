...
/* FUJITSU:2012-2-3 rx_mute st */
static int g_rx_mute = 0;
void voice_req_rx_mute(int mute)
{
	MM_INFO("voice_req_rx_mute %d\n",mute);
	g_rx_mute = mute;
}
/* FUJITSU:2012-2-3 rx_mute st */
...
/*	cmd.rx_mute = 0; FUJITSU:2012-2-3 rx_mute */
	cmd.rx_mute = g_rx_mute; /* FUJITSU:2012-2-3 rx_mute */
