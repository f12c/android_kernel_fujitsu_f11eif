...
#define CCTWR 34		/* I write/read-address of vtx-chip */
#define CCTRD 35
...
/* Get count number of bytes from IツイC-device at address adr, store them in buf. Start & stop
 * handshaking is done by this routine, ack will be sent after the last byte to inhibit further
 * sending of data. If uaccess is 'true', data is written to user-space with put_user.
 * Returns -1 if IツイC-device didn't send acknowledge, 0 otherwise
 */
