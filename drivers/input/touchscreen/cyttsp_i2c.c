...
/* FUJITSU:2011-03-03 modify I2C start */
static struct i2c_device_id cyttsp_i2c_id[] = {
	{ CY_I2C_NAME, 0 },  { }
};
/* FUJITSU:2011-03-03 modify I2C end */
...
/* FUJITSU:2011-03-03 modify I2C start */
    if(system_rev >= 0x0c) {
		cyttsp_i2c_id[0].driver_data = 0;
	}
	else {
		cyttsp_i2c_id[0].driver_data = 4;
	}
/* FUJITSU:2011-03-03 modify I2C end */
