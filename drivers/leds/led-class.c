...
/* FUJITSU:2011-04-28 SUSPEND LED start */
	__ATTR(led_notify, 0644, led_notify_show, led_notify_store),
	__ATTR(led_color, 0644, led_color_show, led_color_store),
...
/* FUJITSU:2011-07-04 LED start */
//	led_cdev->brightness_set(led_cdev, 0);
/* FUJITSU:2011-07-04 LED end */
}
