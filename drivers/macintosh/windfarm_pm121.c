 ...
 *
 * (c) Copyright 2007 ƒe‰tienne Bersac <bersace@gmail.com>
 *
...
static void pm121_cpu_fans_tick(struct pm121_cpu_state *st)
{
	...
	pr_debug("pm121: CPU Fans tick ! CPU temp: %d.%03dƒc[C, power: %d.%03d\n",
...
MODULE_AUTHOR("ƒe‰tienne Bersac <bersace@gmail.com>");
