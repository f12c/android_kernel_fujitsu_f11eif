...
/* FUJITSU:2011-05-31 MDDI-SwingLevel start */
			//mddi_host_reg_out(PAD_CAL, 0x10220020);
			//mddi_host_reg_out(PAD_CAL, 0x11100020);
			mddi_host_reg_out(PAD_CAL, 0xf1fe0020);
			mddi_host_reg_out(DRIVER_START_CNT, 0x00800000);	/* FUJITSU:2011-08-19 for MDDI Type2 */
/* FUJITSU:2011-05-31 MDDI-SwingLevel end */
...
/* FUJITSU:2011-05-31 MDDI-SwingLevel start */
	...
	//pad_reg_val = 0x01100020;
	pad_reg_val = 0x01fe0020;	/* FUJITSU:2011-08-19 for MDDI Type1 */
/* FUJITSU:2011-05-31 MDDI-SwingLevel end */
...
/* FUJITSU:2011-03-03 mddi start cont register change start */
//	mddi_host_reg_out(DRIVER_START_CNT, 0x60006);
/* FUJITSU:2011-07-24 mddi start cont register change start */
//	mddi_host_reg_out(DRIVER_START_CNT, 0x00380000);
//	mddi_host_reg_out(DRIVER_START_CNT, 0x00800000);
	mddi_host_reg_out(DRIVER_START_CNT, 0x00380000);	/* FUJITSU:2011-08-19 for MDDI Type1 */
/* FUJITSU:2011-07-24 mddi start cont register change end */
/* FUJITSU:2011-03-03 mddi start cont register change end */
