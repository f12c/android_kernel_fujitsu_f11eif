...
/*                                                                                */
/*  Off: when the adapter is disabled or hasn't started to associate with AP    */
/*         yet.                                                                          */
/*  BEOn: Once adpater associate with AP successfully                             */
/*  BESlow blinking: whenever adapters do site-survey or try to associate with AP */
...
/*  BEQuick blinking: to blink OFF-ON cycle for each time that traffic packet is  */
