...
{
	struct device	*child;
	if(0){ /* FUJITSU:2011-03-17 DEL fm */
	...
	if(0){ /* FUJITSU:2011-03-17 DEL tsadc */
...
/* FUJITSU:2011-03-17 set for cdc only */
