...
/* Vibe Insensity Config 2013-02-26 Jellicle*/
static int g_dutycycle = 121;
...
int init_module(void)
{
	...
	//struct kobject *tspvibe_kobj;
	tspvibe_kobj = kobject_create_and_add("tspvibe", NULL);
	if (!tspvibe_kobj)
		return -ENOMEM;

	nRet = sysfs_create_file(tspvibe_kobj,
